...
# Crashed.Boot = function (game) {

# };

# Crashed.Boot.prototype = {
...
#         #  Here we load the assets required for our preloader (in this case a background and a loading bar)
#         this.load.image('preloaderBackground', 'images/mainmenu/background.gif');
#         this.load.image('preloaderBar', 'images/mainmenu/Scores.gif');
