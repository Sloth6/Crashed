...
Crashed.Preloader.prototype = {
  ...
  preload: function () {
    ...
    this.load.image('Base', 'images/buildings/base.png');
    ...
    this.load.image('powered', 'images/powered.png');
    ...
    this.load.spritesheet('explosion', 'images/ammo/explosion.png', 64, 64, 25);
    ...
    this.load.image('knockback', 'images/upgrades/knockback.jpg');
